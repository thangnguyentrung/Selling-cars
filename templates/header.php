...
<header>
       <div class="menu">
          <div class="menu-top">
            ...
            <a href="../../home.php"><img src="../../IMG/productsample/Logo/logo.png" alt="logo" srcset=""></a>
            </span>
          ...
          <div class="menu-botton">
             <nav>
              ...
              <div class="menu-left">
                <form action="../search/search.php" method="GET" class="menu-search">
                ...
                <ul class="menu-user">
                    <li> <a href="#" id="user-icon">
                        ...
                        <ul class="menu-item">
                            ...
                            <li><a href="../form/login.php">Đăng nhập</a></li>
